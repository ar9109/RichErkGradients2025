function [lineOut, fillOut] = stdshade(amatrix,alpha,acolor,F,astd,smth)
...
hold on;
lineOut = plot(F,amean, 'color', acolor,'linewidth',2.5); %% change color or linewidth to adjust mean line
