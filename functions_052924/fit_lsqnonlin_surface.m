function [fit_obj_out,fit_obj_gof,x] = fit_lsqnonlin_surface(xdata,ydata,fit_func_fit,p0,lb,ub,seedno,weights,compact_output)
arguments
    xdata
    ydata
    fit_func_fit
...
ft = fittype(fit_func_fit,'independent', {'x', 'y'},'dependent', 'z');
...
results = fit_func_fit(p_cell{:},x(:,1),x(:,2));
