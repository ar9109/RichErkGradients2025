...
%         stack1=im2uint8(loadtiff(mys.dir_paths{k,refCh(k)}{1}));
        stack1=(loadtiff(mys.dir_paths{k,refCh(k)}{1}));
else
...
%             XEnd2  = size2-[1 100 1];
    ...
    [newImage,X1new,subImagesNew]=stitch(stitched{refCh(k)},stack2,[yOffset,xOffset,zOffset],X1,subImages);
...
function [newStack12,newCoord,subImages]=stitch(stack1,stack2,offsets,coord,subImages)
