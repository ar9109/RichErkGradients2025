...
% HYPERRECT is the 3D rectangle to crop [xmin ymin zmin width height depth]
     ...
     ths(2)=th;
     rects(3,:)=rect;  
      clear("permStack2") % edited 041923

     outStack=permute(rotStack2,[1 3 2]); 
       clear("rotStack2") % edited 041923
